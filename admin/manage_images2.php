...
if(isset($_POST['submit'])){
    ...
    foreach( $_FILES['thumb_image']['type'] as $key => $value){
        if($_FILES['thumb_image']['type'][$key] != '' && $_FILES['thumb_image']['type'][$key] != 'image/png' && $_FILES['thumb_image']['type'][$key] != 'image/jpg' && $_FILES['thumb_image']['type'][$key] != 'image/jpeg'){
...
<div class="content pb-0">
    <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Add Images2</strong><small> Form</small></div>
                        <div class="container">
